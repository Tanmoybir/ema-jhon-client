    ...
    return (
        ...
        <div className="flex flex-col sm:flex-row justify-between space-x-0 sm:space-x-12">
                ...
                <form onSubmit={handleLogin}>
                    <div className="flex flex-col space-y-4 mb-4">
                        <div className="flex flex-col space-y-4">
                            <input onBlur={(e) => setEmail(e.target.value)}  className="h-12 border-b-2 border-gray-300 px-4 text-lg focus:outline-none focus:border-blue-500" placeholder="Username" type="text" />
            ...
            <div className="w-full sm:w-1/2">
                ...
                <Link to={'/register'}><button className="inline-flex items-center justify-center rounded-md text-sm font-medium  h-10 px-4 py-2 w-full mb-2 bg-black text-white">CREATE ACCOUNT</button></Link>
