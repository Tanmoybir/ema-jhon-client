...
const HomeSlider = () => {
    ...
    const sliders = [
        { img: 'https://i.ibb.co/ckcWK9H/slider1-ame-jhon.jpg', title: 'Escape 1', des: 'A Symphony of Tranquility. Experience the perfect blend of relaxation and excitement.' },
